...
export default function TermsOfServiceModal({ onClose }: Props) {
  return (
    <div className="fixed inset-0 z-[100] flex justify-center items-start px-4 pb-4 pt-20 sm:pt-24 bg-slate-900/60 backdrop-blur-sm animate-fade-in overflow-y-auto">
