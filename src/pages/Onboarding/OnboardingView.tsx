          ...
          <div className="space-y-5 animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="w-full max-w-full overflow-hidden">
                ...
                <input id="trip-start" type="date" className="input-base w-full max-w-full" value={form.startDate} onChange={(e) => setForm({ ...form, startDate: e.target.value })} />
              </div>
              <div className="w-full max-w-full overflow-hidden">
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">{t('onboarding.endDate')}</label>
                <input id="trip-end" type="date" className="input-base w-full max-w-full" value={form.endDate} onChange={(e) => setForm({ ...form, endDate: e.target.value })} />
              </div>
            </div>
          </div>
        )}
